...
MainFrame.Visible = true  -- Mở khung khi chạy script
...
-- Nút logo bật/tắt khung chức năng
ToggleButton.MouseButton1Click:Connect(function()
    MainFrame.Visible = not MainFrame.Visible
end)

-- Đảm bảo script vẫn chạy khi bị ẩn
spawn(function()
    while wait(1) do
